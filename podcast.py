...
def create_podcast(
    audio_files: typing.List[Segment], output_file_path: str, output_extension="mp3"
) -> str:
    ...
    assert os.path.exists(path_dirname) or os.makedirs(
        path_dirname
    ), f"the directory to which you want to write, {path_dirname}, does not exist."
    audio_segments = [
        (AudioSegment.from_file(a.audio_file, format=a.extension), a.crossfade_time)
